...
class Quiz : public cfc_core::CFC_coreComponents {
private:
    int iteration;
...
class NumberGuessingGame : public cfc_core::NumberGenerator, public cfc_core::CFC_coreComponents {
private:
...
class CannaCalculator : public cfc_core::CFC_coreComponents {
private:
    enum MyEnum
    {
...
class CalculatePowerLoss_Watts_x_Meters : public cfc_core::CFC_coreComponents {
private:
   struct Properties_m {
