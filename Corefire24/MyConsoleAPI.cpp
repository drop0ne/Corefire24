...
void MyConsoleAPI::clearScreen() const {
    COORD topLeft = { 0, 0 };
...
void MyConsoleAPI::cout(const std::string& data) const {
    std::cout << data;
}
void MyConsoleAPI::cout(const std::string& data,const int textColor) const {
    set_text_color(textColor);
    std::cout << data;
}

// Set the console screen color (background and text) using a system call
void MyConsoleAPI::setScreenColor(int backgroundColor, int textColor) const {
...
*/
// Set text color
void MyConsoleAPI::set_text_color(int data) const {
